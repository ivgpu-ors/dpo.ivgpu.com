 ...
 */
     ...
     */ 
        ...
        {
                        /** @var \App\Ivgpu\IvgpuGuard $instance */
...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function makeSet($path)
        {
                        /** @var \App\Services\ImageService $instance */
                        return $instance->makeSet($path);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function copyToWidth($path, $width)
        {
                        /** @var \App\Services\ImageService $instance */
                        return $instance->copyToWidth($path, $width);
        }
...
namespace  { 
            ...
            class Img extends \App\Facades\ImageFacade {}
